...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    $query = "SELECT * FROM servicefirst WHERE id = $id";
...
$service_data = mysqli_fetch_array(mysqli_query($conn, "SELECT * FROM servicefirst WHERE id = $_GET[id]"));
?>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      ...
      <div class="credits">
        ...
        Designed by <a href="https://redrosesid.in/" target="_blank">ABS | Redrose Sid <a href=""></a></a>
      </div>
    </div>
  </footer><!-- End Footer -->
