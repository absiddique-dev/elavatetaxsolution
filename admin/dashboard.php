...
// Target date for rendering the message div
$targetDate = strtotime("02/03/2024");
...
?>
    ...
    <div class="container-fluid" id="container-wrapper">
        ...
        <div class="container bg-secondary text-white w-full md:w-50 rounded p-3" style="height: 260px;">
            <h1 class="text-center text-lg">Happy Birthday</h1>
            <h1 class="text-center m-0 text-xl"><?= $user['name'] ?>,</h1>
            <span class="text-center d-block">( Founder & CEO )</span>
            <p class="text-center text-lg m-0">Another year, You're just getting sweeter.</p>
            <p class="text-center text-lg m-0">Wishing you a tax-free day of celebration! Happy Birthday!</p>
            <p class="text-right mr-5 mt-3"> <p class="text-right mr-5 mt-3"> <a class="decoration-none text-white" href="https://wa.me/+916002618132/?text=Thank%20You">- A.B Siddique</a> </p> </p>
            <div style="width: 400px; height: 300px;margin: -200px 0px 0px 25vw">
            <style>
                .conf0 {
                    fill: #FC6394;
                }
        ...
        <!-- End of birthday message div -->
    </div>
    <!-- End of Container Fluid-->
<?php
} else {
    // Render the message showing time remaining
?>
    <!-- Container Fluid-->
    <div class="container-fluid" id="container-wrapper">
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <!-- Message showing time remaining div -->
        <div class="container bg-secondary text-white w-full md:w-50 rounded p-3">
            <p class="text-center text-lg m-0">Something special comming soon!</p>
        </div>
        <!-- End of message showing time remaining div -->
    </div>
    <!-- End of Container Fluid-->
<?php
}
